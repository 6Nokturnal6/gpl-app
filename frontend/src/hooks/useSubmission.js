...
export const emptyDocentesResultados = () => ({ grupoEtario: [emptyAgeDocente()], areaFormacao: [emptyDegreeRow('area_formacao')], cursoFormacao: [emptyDegreeRow('curso_formacao')], categoria: [{ regime:'tempo_inteiro', categoria:'', homens:0, mulheres:0 }], relacao: [{ relacao:'Pertence ao quadro', lic_h:0, lic_m:0, mest_h:0, mest_m:0, dout_h:0, dout_m:0 }, { relacao:'Não pertence ao quadro', lic_h:0, lic_m:0, mest_h:0, mest_m:0, dout_h:0, dout_m:0 }] });
