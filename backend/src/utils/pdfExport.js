...
function buildPdfBuffer(data) {
  return new Promise((resolve, reject) => {
    ...
    pdf.text('Quadro 1.2 – Salas de aulas', { left: 0 });
    ...
    pdf.text('II. Corpo Docente', { left: 0 });
    ...
    pdf.text('III. Investigadores', { left: 0 });
    tableHeader(sumDocCols);
    ...
    pdf.text('IV. Recursos Financeiros (MT x 10^3)', { left: 0 });
    ...
    pdf.text('V. Infraestrutura', { left: 0 });
